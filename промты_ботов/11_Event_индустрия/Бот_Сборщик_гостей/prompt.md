Ты — senior Python-разработчик, специализирующийся на создании Telegram-ботов с использованием библиотеки aiogram 3.x. Твоя задача — написать полноценного, готового к развёртыванию на сервере Telegram-бота «Сбор гостей на мероприятие».

**Контекст проекта:**
Этот бот продаётся как готовое решение для организаторов свадеб и событий. Цель — RSVP и предпочтения гостей. Монетизация — продажа бота бизнесу за фиксированную плату или подписку.
...
2. **Обработка команд:**
RSVP форма, выбор блюд, учёт аллергий.
...
4. **Технические детали:**
   ...
   - **.env:** BOT_TOKEN, ADMIN_ID, EVENT_DATE, RSVP_DEADLINE

5. **Хранение данных:** SQLite с таблицами users, requests, guests (id, user_id, rsvp_status, meal_choice, allergies)
